...
@register.inclusion_tag('friendship/templatetags/friend_requests.html')
def read_requests(user):
    """
    Inclusion tag to display friend requests
    """
    return {'read_requests': Friend.objects.read_requests(user)}

@register.inclusion_tag('friendship/templatetags/rejected_requests.html')
def rejected_requests(user):
    """
    Inclusion tag to display rejected requests
    """
    return {'rejected_requests': Friend.objects.rejected_requests(user)}

@register.inclusion_tag('friendship/templatetags/sent_requests.html')
def sent_requests(user):
    """
    Inclusion tag to display sent requests
    """
...
def unread_request_count(user):
    """
    Inclusion tag to display the count of unread friend requests
    """
    return {'unread_request_count': Friend.objects.unread_request_count(user)}
